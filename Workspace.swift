    ...
    schemes: [
        .scheme(
            ...
            buildAction: .buildAction(targets: [
                ...
                .project(path: "Projects/App", target: "ZohoBookkeeperWatch")
            ])
        ),
        .scheme(
        ...
        .scheme(
            ...
            buildAction: .buildAction(targets: [.project(path: "Projects/App", target: "ZohoBookkeeperWatch")]),
            runAction: .runAction(executable: .project(path: "Projects/App", target: "ZohoBookkeeperWatch"))
        )
    ],
